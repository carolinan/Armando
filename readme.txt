...
* Version: 2.0.1.
Removed the backwards compatibility check since it is no longer needed.
Updated the theme for WordPress 6.2.
Updated the Search results page and archie page so that the page title shows correctly.
Remove unneccesary block pattern categories.
